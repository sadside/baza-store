...
export const LoyaltyPage = () => {
  ...
  return (
    <div>
      ...
      <StatusLoyalty />
      {countViews < 10 && (
        <div className="mt-5 max-[785px]:px-[10px] w-full bg-lightGray justify-between max-[785px]:flex-col gap-[18px]  flex">
          <div className=" max-[785px]:w-[100%] max-[785px]:mt-[10px]  flex justify-center items-center w-[20%] h-[15vh] bg-backBazaLogo">
            <span className="opacity-[100%]">
              <SvgSelector id={'baza-icon'} />
            </span>
          </div>
          <div className="flex flex-col  max-[785px]:justify-center w-[100%] justify-around">
            <div className="text-black-400 flex font-medium uppercase max-[785px]:justify-center ">
              Получите 300 бонусов
            </div>
            <div className="  w-[98%] text-black-200  max-[785px]:text-center ">
