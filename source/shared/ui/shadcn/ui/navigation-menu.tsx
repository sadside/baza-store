...
import { ArrowDownAZIcon, ArrowDownIcon, ChevronDown, PlusIcon } from 'lucide-react';
...
>(({ className, children, ...props }, ref) => (
  <NavigationMenuPrimitive.Trigger
    ref={ref}
    className={cn(navigationMenuTriggerStyle(), 'group border-0', className)}
    {...props}
  >
    {children} {/*<PlusIcon*/}
