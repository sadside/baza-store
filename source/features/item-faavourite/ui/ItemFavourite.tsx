...
export const ItemFavourite = ({ item }: { item: Favorite }) => {
  ...
  return (
    <div className="w-[200px] max-[620px]:w-[165px] overflow-hidden  flex flex-col justify-center align-middle text-center ">
      <div className="relative group">
        ...
        <div className=" top-0 left-0 right-0 bottom-0 hidden  absolute  group-hover:flex  ">
          <span className=" left-[5px] pt-[3px] top-[100px]" onClick={removeHandleCLick}>
