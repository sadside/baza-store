  ...
  return (
    <div>
      <div className="flex justify-between items-center">
        <div
          className={twMerge(
            "flex flex-col items-center border-b border-black-100 max-[550px]:text-[11px] flex-1 hover:bg-black-5 cursor-pointer transition-all duration-500 pt-1.5",
        ...
        >
          <div
            className={twMerge("text-black-100 max-[550px]:text-[11px] font-semibold uppercase", activeTab === "cdek" && "text-black")}>
            В пункте сдэк
          </div>
        ...
        >
          <div
            className={twMerge("text-black-100 max-[550px]:text-[11px] font-semibold uppercase", activeTab === "inShop" && "text-black")}>
            В магазине
          </div>
      ...
      <div className="mt-5 max-w-[544px] max-[550px]:mt-2.5 ">
      ...
      <div className="mt-7 max-[550px]:mt-2.5  max-[470px]:w-full w-[221px] mb-7">
