...
//     const products: IProductCart[] = JSON.parse(localStorage.getItem('products') || '[]');
//   }
//
//   let totalPrice = 0;
//
//   products.forEach(({ price, quantityInCart }) => {
//     totalPrice += quantityInCart ? price * quantityInCart : price;
//   });
//
...
//             {products?.map(
//               ({ name, slug, price, id, image, quantityInCart, size, color, old_price, quantityInShop }) => (
//                 <DropdownCartItem
//                   slug={slug}
