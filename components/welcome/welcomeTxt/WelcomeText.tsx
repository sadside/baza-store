  ...
  return (
    <div className={s.root}>
      <span className={s.top}>
        <div className={s.name}>ДОБРО ПОЖАЛОВАТЬ{user?.name && `, ${user.name}`}</div>
      ...
      <div className={s.content}>
        <span className={s.txt}>
          Мы вносим улучшения в "Мою учетную запись", чтобы предложить вам лучший опыт. Некоторые из ваших заказов могут
