...
const WelcomeText = () => {
    ...
    return (<div className={s.root}>
        ...
        <div className={s.content}><span className={s.txt}>Мы вносим улучшения в "Мою учетную запись", чтобы предложить вам лучший опыт. Некоторые из ваших заказов могут быть не видны ниже, пожалуйста, <span
            className={s.line}>свяжитесь с нами для </span>получения дополнительной помощи. Если вы хотите вернуть заказ, который не отображается ниже, пожалуйста, посетите нашу страницу <span
